...
### 1. Download & Install
Download the latest `R-Tweaks.apk` from the **[Releases](https://github.com/Benyiiiii/R-Tweaks_NotificationApp/releases)** section and install it on your Android device.
